...
const struct ieee80211_regdomain regdom_europ = {
	.n_reg_rules = 5,
...
const struct ieee80211_regdomain regdom_tr = {
	...
	REG_RULE_LIGHT(5180-10, 5240+10, 80, 0),
	/* channels 52..64 */
	REG_RULE_LIGHT(5260-10, 5320+10, 80, 0),
	/* channels 100..140 */
	REG_RULE_LIGHT(5500-10, 5700+10, 40, KAL_RRF_DFS) }
};
...
const struct ieee80211_regdomain regdom_au = {
	...
	REG_RULE_LIGHT(5260-10, 5320+10, 80, KAL_RRF_DFS),
	/* channels 100..116 */
	REG_RULE_LIGHT(5500-10, 5580+10, 80, 0),
	/* channels 132..144 */
	REG_RULE_LIGHT(5660-10, 5720+10, 80, KAL_RRF_DFS),
	/* channels 149..165 */
	REG_RULE_LIGHT(5745-10, 5825+10, 80, 0) }
...
const struct ieee80211_regdomain regdom_mx = {
	...
	REG_RULE_LIGHT(5260-10, 5320+10, 40, KAL_RRF_DFS),
	/* channels 100..116 */
	REG_RULE_LIGHT(5500-10, 5580+10, 40, KAL_RRF_DFS),
	/* channels 132..144 */
	REG_RULE_LIGHT(5660-10, 5720+10, 40, KAL_RRF_DFS),
	/* channels 149..165 */
	REG_RULE_LIGHT(5745-10, 5825+10, 40, 0) }
};
